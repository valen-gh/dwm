...
static char spfgcolor[]	    	= "#eeeeee";
static char spbgcolor[]	    	= "#eeeeee";
static char *colors[][3] = {
       /*                fg            bg            border   */
       [SchemeNorm]  = { normfgcolor,  normbgcolor,  normbordercolor },
       [SchemeSel]   = { selfgcolor,   selbgcolor,   selbordercolor  },
       [SchemeSp]    = { spfgcolor,    spbgcolor,    normbordercolor },
};
...
ResourcePref resources[] = {
                ...
                { "spfgcolor",          STRING,  &spfgcolor },
                { "spbgcolor",          STRING,  &spbgcolor },
};
